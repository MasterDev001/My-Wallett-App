...
@Composable
fun DialogEditCurrency(
    currency: CurrencyData,
    onDismissRequest: () -> Unit,
    onAddClick: (CurrencyData) -> Unit
) {

    var currencyName by remember { mutableStateOf(currency.name) }
    var currencyRate by remember { mutableStateOf(currency.rate.toString()) }
        ...
        Card(Modifier.padding(8.dp), shape = RoundedCornerShape(padding_10)) {
            Column(
                ...
                Text(
                    ...
                    text = stringResource(R.string.valyutani_tahrirlash),
